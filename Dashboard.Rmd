...
# Filter out "Lakshadweep" from the dataset
...
plot_ly(data = filtered_data, x = ~State) %>%
  add_lines(y = ~Relative_Literacy_Rate, name = "Relative Literacy Rate", line = list(color = "darkred")) %>%
  add_lines(y = ~Relative_Share_Of_Cases_Registered, name = "Relative Share of Cases Registered", line = list(color = "black")) %>%
  layout(title = "Literacy Rate vs Per-capita Cases Registered",
         yaxis = list(title = ""),
         xaxis = list(title = ""))
```
